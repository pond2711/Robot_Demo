...
${LOBOTEC}  https://robotec.org/th/blog/types-of-industrial-robot.html
...
Searching "robot" on Google, the search result should contain Lobotec Directory
    Press Keys    id=APjFqb    ENTER
    Page Should Contain Link    ${LOBOTEC}